...
## v23.0.0 — 2026-07-12
**Commit:** `f70b502` — fix(ci): fail closed without TV or master promotion authority  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 29206534584)
...
## v22.0.0 — 2026-07-12
**Commit:** `38e15ac` — fix(ai-agent): prevent automated master-record mutation  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 29206257934)
...
## v21.0.0 — 2026-07-12
**Commit:** `1e25e33` — fix(ai-agent): bound public OSINT sweep runtime  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 29184121303)
...
## v20.1.0 — 2026-07-11
**Commit:** `aff671a` — chore(workflow): activate AI Search Agent through declared push trigger  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 29179043522)

<details><summary>Changed files</summary>

```txt
data/sources/workflow_activation_20260711T220000Z.json
```
</details>
...
## v20.0.0 — 2026-07-11
**Commit:** `7f19200` — ci(evidence): run deterministic zero-hit evidence preflight  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 29178316800)
...
## v19.0.0 — 2026-07-11
**Commit:** `eae420b` — ci(evidence): trigger sweep on run-evidence contract changes  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 29178282517)
...
## v18.0.0 — 2026-07-11
**Commit:** `d77c18d` — feat(evidence): receipt and Merkle-anchor every OSINT sweep  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 29178252035)
...
## v17.3.0 — 2026-07-11
**Commit:** `6b160f9` — feat(evidence): preserve every OSINT sweep as reconstructable run evidence  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 29178238147)

<details><summary>Changed files</summary>

```txt
scripts/search_run_evidence.py
```
</details>
...
## v17.2.0 — 2026-07-11
**Commit:** `a7c3e16` — feat(evidence): validate batch continuity and inclusion proofs  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 29177207722)

<details><summary>Changed files</summary>

```txt
scripts/validate_evidence_outputs.py
```
</details>
...
## v17.1.0 — 2026-07-11
**Commit:** `7dfb860` — feat(evidence): chain Merkle batches and emit inclusion proofs  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 29177198273)
...
## v17.0.0 — 2026-07-11
**Commit:** `519ce97` — ci(evidence): validate and persist portable evidence chain outputs  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 29176872699)
...
## v16.1.0 — 2026-07-11
**Commit:** `88c4e49` — fix(evidence): conform FREE-DOM receipts to canonical ST-007 schemas  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 29176855238)
...
## v16.0.0 — 2026-07-11
**Commit:** `e875c82` — feat(evidence): emit governed discovery manifests and receipts  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 29176837503)
...
## v13.0.2 — 2026-02-26
**Commit:** `ff431b5` — Update pending_unverified_template.csv  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22437623776)
...
## v13.0.1 — 2026-02-26
**Commit:** `59ecd02` — Update pending_unverified_template.csv  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22437576585)
...
| master_timeline.csv | 1165 |
| verified_people_events.csv | 2 |
| unverified_events.csv | 2 |
| unverified_people.csv | 2 |
| unverified_connections.csv | 2 |
...
## v13.0.0 — 2026-02-26
**Commit:** `9f580a4` — Update auto_update_tv_patch.yml  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22437547751)
...
## v12.0.0 — 2026-02-26
**Commit:** `a5c5677` — Update auto_update_tv_patch.yml  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22437161371)
...
## v11.0.0 — 2026-02-26
**Commit:** `3dd9491` — Update auto_update_tv_patch.yml  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22437103164)
...
## v10.3.8 — 2026-02-26
**Commit:** `801697d` — Update README.md  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22437048341)
...
## v10.3.3 — 2026-02-26
**Commit:** `58feeb3` — Delete data/pending_updates_news_oct2025.csv  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22436739786)

<details><summary>Changed files</summary>

```txt
data/pending_updates_news_oct2025.csv
```
</details>
...
## v10.3.2 — 2026-02-26
**Commit:** `f6b71b9` — Delete data/pending_updates_07.csv  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22436651056)

<details><summary>Changed files</summary>

```txt
data/pending_updates_07.csv
```
</details>
...
## v10.3.1 — 2026-02-26
**Commit:** `0fa64cc` — Delete data/structure.txt  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22436493001)
...
## v10.3.0 — 2026-02-26
**Commit:** `d00282d` — Rename data/sources_index.md to data/sources/sources_index.md  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22436336024)

<details><summary>Changed files</summary>

```txt
data/sources/sources_index.md
```
</details>
...
## v10.2.0 — 2026-02-26
**Commit:** `3c3e4bb` — Rename data/sources_whitelist.csv to data/sources/sources_whitelist.csv  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22436317508)
...
## v10.1.0 — 2026-02-26
**Commit:** `4053aed` — Update and rename sources_whitelist.csv to sources_whitelist_template.csv  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22436303207)

<details><summary>Changed files</summary>

```txt
data/sources/sources_whitelist_template.csv
```
</details>
...
## v10.0.1 — 2026-02-26
**Commit:** `43156cc` — Update README.md  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22435674833)
...
## v10.0.0 — 2026-02-26
**Commit:** `ad4c8aa` — Update auto_update.yml  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22435648294)
...
## v9.0.0 — 2026-02-26
**Commit:** `d629ad5` — Update auto_update_tv_patch.yml  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22435456353)
...
## v8.2.0 — 2026-02-26
**Commit:** `071236e` — Update tv_fetch.py  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22435393913)
...
## v8.1.6 — 2026-02-26
**Commit:** `0704319` — Update README.md  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22435321172)
...
## v8.1.5 — 2026-02-26
**Commit:** `ce16b63` — Update README.md  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22434960417)
...
## v8.1.4 — 2026-02-26
**Commit:** `afc3207` — Update README.md  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22434635965)
...
## v8.1.3 — 2026-02-26
**Commit:** `626d2a6` — Update and rename pending_people_template.csv to data/pending/pending_people_template.csv  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22434364902)

<details><summary>Changed files</summary>

```txt
data/pending/pending_people_template.csv
```
</details>
...
```txt
data/pending/pending_updates_template.csv
```
</details>
...
## v8.1.0 — 2026-02-26
**Commit:** `f8bc516` — Update and rename sources_whitelist.csv to data/sources/sources_whitelist.csv  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22434295119)
...
## v8.0.0 — 2026-02-26
**Commit:** `3a82780` — Update auto_update.yml  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22433894000)
...
## v5.0.0 — 2026-02-26
**Commit:** `6c24cbb` — Update import_pending.py  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22433776455)
...
## v4.1.0 — 2026-02-26
**Commit:** `45df823` — Update build_ai_agent_summary.py  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22433749691)
...
## v4.0.0 — 2026-02-26
**Commit:** `0f13576` — Update search_agent.py  
**Author:** StegVerse  **Branch:** `main`  **Workflow:** `Merge Pending, Build Checklist & Changelog, Validate` (run 22433730227)
